...
import com.yb.spotifyalbums.data.remote.repos.AlbumRepository
...
class NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideAlbumRepository(albumRepository: AlbumRepository): IAlbumRepository = albumRepository
